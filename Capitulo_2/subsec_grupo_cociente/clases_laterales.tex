...
\begin{proof}
	Basta probar que $\mathcal{R}$ induce una relación de equivalencia, es decir la relación $\sim$ definida por $a \sim b \iff a, b \in Hg$ es de equivalencia.
	\begin{enumerate}[label=\roman*), font=\normalfont]
		...
		\item \textsc{Transitividad:} Si $a \sim b \land b \sim c \implies a, b \in Hg_1 \land b, c \in Hg_2$. \par	     
