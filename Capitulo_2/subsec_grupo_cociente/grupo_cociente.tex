...
\begin{prop}
	Sea $(G, \circ, e)$ un grupo, sea $N \trianglelefteq G$, sea $G/N = \mathcal{L} = \mathcal{R}$, $*$ definida por $(aN)*(bN) = ab$ en $G/N$ está bien definida, es decir no depende del representante de clase, más aún $G/N$ es un grupo.
\end{prop}
