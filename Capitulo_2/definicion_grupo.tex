...
\begin{enefecto} note:
	\begin{enumerate}[label=\roman*), font=\normalfont]
		...
		\item Tenemos $\underline{0} \in \mathcal{H}$, definida por: $\underline{0}(a) = 0 \quad \forall a \in A$, sea $f \in \mathcal{H}$, sea $a \in A$,
		      ...
		      \end{equation*}
		      Así $f+\underline{0} = f$, es decir $\underline{0}$ es el elemento neutro.
...
\begin{enefecto} Note:
	\begin{enumerate}[label=\roman*), font=\normalfont]
		...
		\item Sea $\bar{a} \in G$, entonces $(a, n) = 1$, por tanto $\exists x, y \in \mathbb{Z}$, tal que:
		      ...
		      \end{equation*}
		      es decir existe $\bar{x} \in G$, tal que $\bar{a} \cdot \bar{x} = 1$.
	\end{enumerate}
\end{enefecto}
...
\begin{proof}
	...
	\begin{equation*}
		g^{-1} \circ g = e, \quad \text{es decir } g \circ g^{-1} = g^{-1} \circ g = e
	\end{equation*}
\end{proof}
...
\begin{proof}
	...
	\begin{equation*}
		e = e \circ e' = e' \circ e = e', \quad \text{es decir } e \text{ es único.}
	\end{equation*}
\end{proof}
