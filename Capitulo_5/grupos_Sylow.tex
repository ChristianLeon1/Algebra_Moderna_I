...
\begin{eje}
    ...
    \begin{equation*}
        G \cong Q \rtimes P
    \end{equation*}
    Este grupo es único salvo isomorfismo (todos los homomorfismos no triviales dan lugar a grupos isomorfos en este caso). \par 
    Ejemplo: $S_3$ tiene orden $6 = 2 \cdot 3$. Aquí $p=2, q=3$. Como $2 \mid (3-1)$, existe el grupo no abeliano $S_3 \cong \mathbb{Z}_3 \rtimes \mathbb{Z}_2$.
\end{eje}
